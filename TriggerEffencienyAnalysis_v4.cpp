...
int checkTrigger2(string file_name)
{
    ...
    cout <<endl<< double(pass_line)/total*100 << "% " << endl;
    return 1;
}
...
int checkTrigger1(string file_name)
{
    ...
    cout<< endl << double(pass_layer)/total*100 << "% " << endl;
    return 1;
}
...
void all_files(string file_name){
    cout << endl << "Trigger 1 enabled: " << endl;
    scan_all(file_name+"_1.log");

    cout << endl << "Trigger 2 enabled: " << endl;
    scan_all(file_name+"_2.log");

    cout << endl << "Trigger 3 enabled: " << endl;
    scan_all(file_name+"_3.log");

    cout << endl << "Trigger 4 enabled: " << endl;
    scan_all(file_name+"_4.log");
}